...
public final class Helper {
	...
	public static void write(ICharsetCodec cc, CharBuffer cb,
	...
	public static int prepend(IByteSequence src, int offset, int length,
			IUnit unit) {
	...
	public static void prepend(ICharsetCodec cc, StringBuilder sb,
			IUnitChain unitChain) {

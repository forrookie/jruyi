...
public final class BundleCmd {
	...
	public void stop(String[] bundleIds) throws Exception {
	...
	public void uninstall(String[] bundleIds) throws Exception {
		if (bundleIds == null || bundleIds.length == 0) {
	...
	public void update(String[] bundleIds) throws Exception {
		BundleContext context = m_context;
		if (bundleIds == null || bundleIds.length < 1) {
	...
	public void update(String arg) throws Exception {
